...
function iniciarConexionNube() {
    ...
    database.ref('comentarios_generales').on('value', (snapshot) => {
        ...
        if(datos) {
            ...
            lista.innerHTML = '<p style="color:var(--grey); font-size:0.9em; text-align:center; margin-top:10px;">No hay avisos aún. ¡Escribe el primero!</p>';
        }
    });
...
function enviarComentarioGeneral() {
    ...
    let btn = document.getElementById('btn-send-comment');
